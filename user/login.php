  ...
  <div class="min-h-screen bg-gray-100 text-gray-900 flex justify-center">
    ...
    <div class="max-w-screen-xl m-0 sm:m-10 bg-white shadow rounded-3xl flex justify-center flex-1 shadow-xl">
          ...
          <div class="w-full flex-1 mt-8">
            ...
            <div class="mx-auto max-w-xs">
              ...
              <form class="pt-3" id="login" method="post" name="login">
                ...
                <div class="mt-3">
                  <button class="mt-5 tracking-wide font-semibold bg-green-300 text-black w-full py-4 rounded-lg flex items-center justify-center focus:shadow-outline focus:outline-none" name="login" type="submit">Login</button>
                </div>
      ...
      <div class="flex-1 bg-indigo-100 text-center hidden lg:flex rounded-r-3xl relative bg-cover bg-center bg-no-repeat" style="background-image: url('https://cdn.mos.cms.futurecdn.net/YSs8CNikC5Va6SE9MerbZM-1200-80.jpg');">
        ...
        <label for="reset" class="btn btn-md btn-circle btn-ghost float-right absolute right-2 top-2 "><a href="forgot-password.php" class="tooltip tooltip-left tooltip-accent" data-tip="Reset Passkey"><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="white" class="w-6 h-6">
